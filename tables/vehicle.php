		...
		<tr>
			...
			<td>
				<div class="btn-group btn-group-sm">
					<a href="../vehicle/vehicle_view.php?v_id=<?php echo $row['id'] ?>" class="btn btn-outline-success mr-2 action-icon" id="view-btn"><i class="bi bi-eye-fill"></i><br/></a>
					<a href="../vehicle/edit_vehicle.php?vehicle_id=<?php echo $row['id'] ?>" class="btn btn-outline-primary mr-2 action-icon" id="edit-btn"><i class="fa fa-pencil"></i><br/></a>
