...
if(empty($vehicle_title) || empty($vehicle_category) || empty($price_per_day) ||empty($brand_name) ||empty($model_year) || empty($fluel_type) || empty($seat_capacity) ||empty($description)  ){
    echo "System Error!"; 
    exit();
}else{
